...
#define FIXEDWIFI "Wokwi-GUEST/" // Add a fixed SSID to the list (WiFi only)
...
// #define LCD1602I2C                                        // LCD 1602I2C display with I2C backpack
#define LCD4002I2C // LCD 4002I2C display with I2C backpack
